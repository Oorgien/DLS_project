    ...
    def save_networks(self, epoch):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                save_path = str(self.save_dir) + '/' + str(save_filename)
                net = getattr(self, 'net' + name)
    ...
    def load_networks(self, epoch):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                unexpected_2 = [
                    "model.10.conv_block.6.running_mean", "model.10.conv_block.6.running_var",
                    "model.10.conv_block.6.num_batches_tracked", "model.11.conv_block.6.running_mean",
                    "model.11.conv_block.6.running_var", "model.11.conv_block.6.num_batches_tracked",
                    "model.12.conv_block.6.running_mean", "model.12.conv_block.6.running_var",
                    "model.12.conv_block.6.num_batches_tracked", "model.13.conv_block.6.running_mean",
                    "model.13.conv_block.6.running_var", "model.13.conv_block.6.num_batches_tracked",
                    "model.14.conv_block.6.running_mean", "model.14.conv_block.6.running_var",
                    "model.14.conv_block.6.num_batches_tracked", "model.15.conv_block.6.running_mean",
                    "model.15.conv_block.6.running_var", "model.15.conv_block.6.num_batches_tracked",
                    "model.16.conv_block.6.running_mean", "model.16.conv_block.6.running_var",
                    "model.16.conv_block.6.num_batches_tracked", "model.17.conv_block.6.running_mean",
                    "model.17.conv_block.6.running_var", "model.17.conv_block.6.num_batches_tracked",
                    "model.18.conv_block.6.running_mean", "model.18.conv_block.6.running_var",
                    "model.18.conv_block.6.num_batches_tracked"
                ]
                for i in range(len(missings)):
                    state_dict[missings[i]] = state_dict.pop(unexpecteds[i])

                for i in range(len(unexpected_2)):
